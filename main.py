...
# Parámetros dados al buscador de puntos clave
parametros = dict(maxCorners=100, qualityLevel=0.3, minDistance=7, blockSize=7)

# Puntos clave obtenidos de la primera imagen
esquinasIniciales = cv2.goodFeaturesToTrack(primeraImagenGris, mask = None, **parametros)
